...
export default function Devices({ }) {
  ...
  const handleSwitchChange = (index) => {
    ...
    updatedDevices[index] = {
      ...updatedDevices[index],
      isSwitchOn: !updatedDevices[index].isSwitchOn,
    };
  ...
  return (
    <View>
      <Pressable
        ...
        onPress={() => setShowDevicesMenu(true)}
      >
        <Text style={{ marginHorizontal: 5 }} variant="titleMedium">
          Devices
        </Text>
        <Menu
        ...
        >
          ...
          <Menu.Item
            onPress={() => {
              setShowDevicesMenu(false);
              setshowRemoveDevice(!showRemoveDevice);
            }}
            title={!showRemoveDevice ? "Remove Device" : "cancel remove"}
          />
        </Menu>
      </Pressable>
